...
-(void)update:(CCTime)dt
{
    ...
    if (_timeUntilNextBird <= 0)
    {
        ...
        _timeUntilNextBird = 10000;//nextBirdTime;
    }
...
-(void)spawnBird
{
    ...
    //1
    CCActionCallFunc *turnaround =
    [CCActionCallFunc actionWithTarget:bird
                              selector:@selector(turnaround)];
    ...
    [CCActionRepeatForever
     actionWithAction:moveLeftThenBack];
