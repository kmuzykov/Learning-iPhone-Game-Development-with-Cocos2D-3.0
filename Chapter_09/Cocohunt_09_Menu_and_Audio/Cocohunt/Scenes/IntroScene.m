...
-(void)onEnter
{
    ...
    //[self animateCoconutExplosion]; //This is commented out in Time for Action – Adding Menu Buttons (Chapter 9)
    [self proceedToGameScene];        //Instead we're prociding straight to game. This is only done to skip explosion animation while we're testing everything.
    
    //Preloading sound effects while explosion animation is played.
