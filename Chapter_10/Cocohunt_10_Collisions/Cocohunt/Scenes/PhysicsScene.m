...
-(void)addGround
{
    ...
    //Setting collision type to detect collisions with the ground
...
-(void)spawnStone
{
    ...
    //Setting stone collision type to identify collisions with the stone
    ...
    //Placing in its initial position (it will start its falling from here)
    CGSize viewSize = [CCDirector sharedDirector].viewSize;
